...
class UpvoteDownvote extends Component
{
    ...
    {
        $upvotes = ModelsUpvoteDownvote::where("post_id", "=", $this->post->id)->where("is_upvote", "=", true)->count();
        $downvotes = ModelsUpvoteDownvote::where("post_id", "=", $this->post->id)->where("is_upvote", "=", false)->count();
        $hasUpvote = null;
